...
export const PaginationUtilsEBS = typeUtils = {
    /**
     ...
     *                  
     */
    async generateHeader (type, nbMaxAllow , elementCount , lengthResponse , hostname, queryParams) {
     ...
     */
    async generateStatus (nbMaxElement , nbElement) {
     ...
     *            
     */
    async generatesResponse (type, nbMaxAllow , elementCount , lengthResponse , hostname, queryParams , res) {
     ...
     */
    async createUrl (url, queryParams) {
        let newUrl
     ...
     *                  maximum number allow
     */
    async checkAcceptRange (size , nbMaxAllow) {
        if( size > nbMaxAllow){
     ...
     *                  all query params (req.query) 
     */
    async checkDefaultSizeAndPage (queryParams) {
        try {    
     ...
     *                          maximum number allow
     */
    async StartOnPagination  (queryParams , nbMaxAllow) {
        try {

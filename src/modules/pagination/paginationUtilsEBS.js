 ...
 *
 */
function generateHeader(type, nbMaxAllow, elementCount, lengthResponse, hostname, queryParams) {
...
function createUrl(url, queryParams) {
  ...
  if (typeof url === 'string') {
    ...
    throw new TechnicalException(
      new ErreurDO(
        paginationUtilsEBSError.createUrl.field,
        paginationUtilsEBSError.createUrl.code,
        paginationUtilsEBSError.createUrl.label,
      ),
    )
  }
  if (queryParams !== null) {
...
function checkAcceptRange(size, nbMaxAllow) {
  if (size > nbMaxAllow) {
    throw new BusinessException(
      new ErreurDO(
        paginationUtilsEBSError.checkAcceptRange.field,
        paginationUtilsEBSError.checkAcceptRange.code,
        paginationUtilsEBSError.checkAcceptRange.label,
      ),
    )
  }
}

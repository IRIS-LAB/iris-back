...
import { ErrorService } from '../interfaces/error-service.interface'
import { MessageProvider } from './message.provider'

@Injectable()
export class ErrorProvider implements ErrorService {
  ...
  public createBusinessException(fieldOrOptions: string | ErrorServiceOptions, code?: string, datas?: object): BusinessException {
    return this.createIrisException(BusinessException, ErrorProvider.mapArgsToOptions(fieldOrOptions, code, datas))
  }

  public createSecurityException(fieldOrOptions: string | ErrorServiceOptions, code?: string, datas?: object): SecurityException {
    return this.createIrisException(SecurityException, ErrorProvider.mapArgsToOptions(fieldOrOptions, code, datas))
  }
  ...
  public createEntityNotFoundBusinessException(fieldOrOptions: string | (ErrorServiceOptions & { value?: any }), id?: any, code?: string, datas?: object): EntityNotFoundBusinessException {
    return this.createIrisException(EntityNotFoundBusinessException, ErrorProvider.mapArgsToOptions(fieldOrOptions, code, {...datas, id, value: id}, {
  ...
  public createTechnicalException(fieldOrOptions: string | ErrorServiceOptions, code: string | Error, e?: Error, datas?: object): TechnicalException {
    return new TechnicalException(this.getError(ErrorProvider.mapArgsToOptions(fieldOrOptions, code as string, datas)), typeof fieldOrOptions === 'string' ? e! : code as Error)
  }
